...
//   setEditingGenreId: Dispatch<SetStateAction<number | null>>;
//   setSelectedGenreId: Dispatch<SetStateAction<number | null>>;
//   setSelectedGenreName: Dispatch<SetStateAction<string | null>>;
// }

// const GenreListItem: React.FC<Props> = ({
//   genre, isEditing, onEditClick, onDeleteClick, editingGenreId, setEditingGenreId, setSelectedGenreId, setSelectedGenreName
// }) => {
//   // 編集ボタンが押されたジャンル
//   if (isEditing && genre.id === editingGenreId) {
//     return (
//       <li 
//         key={genre.id}
//         className="h-10 w-full p-1 flex justify-between items-center rounded-sm shadow-sm bg-white"
//       >
//         <GenreForm genreId={genre.id} defaultName={genre.name} setEditingGenreId={setEditingGenreId} />
//       </li>
//     )
//   }
